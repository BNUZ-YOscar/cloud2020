...
//    @SentinelResource(value = "fallback", fallback = "handlerFallback") 只配置业务异常
//    @SentinelResource(value = "fallback", blockHandler = "blockHandler") 只配置控制台配置异常
    ...
    public CommonResult handlerFallback(@PathVariable Long id, Throwable e) {
        ...
        return new CommonResult(444, " 异常 handlerFallback ， exception 内容： " + e.getMessage(), payment);
    }
